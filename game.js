...
return i.actors=[],i.tweens=[],i.transitioning=!1,i.init=function(){i.tweens.push(new PositionTween({target:i.camera,durationFrames:Util.secondsToFrames(1),startX:Constants.SCREEN_WIDTH,endX:0,callback:i.animateTitles.bind(i)})),i.actors.push(new Background)
var t=new Box(i)
t.x=Constants.SCREEN_WIDTH/2-64-24,t.w=90,i.actors.push(t)
t=new Cat(i)
t.x=Constants.SCREEN_WIDTH-64,t.right=!1,t.w=60,i.actors.push(t)
t=new CallToAction(i)
i.actors.push(t)},i.update=function(){for(var t=0,e=i.tweens;t<e.length;t++)e[t].TIC()
for(var n=0,s=i.actors;n<s.length;n++)s[n].update()},i.draw=function(){for(var t=0,e=i.actors;t<e.length;t++)e[t].draw()
print("a game for ludum dare #54 by @cheesepencil",4-i.camera.x,Constants.SCREEN_HEIGHT-8-i.camera.y,14)},i}return __extends(TitleScene,t),TitleScene.prototype.animateTitles=function(){var t=new FancyText
...
o.printMe(n,s)}}return FancyText.prototype.printMe=function(t,e){return print(this.text,this.x-t,this.y-e,this.textColor,this.fixedWidth,this.scale,this.smallFont)},FancyText}()
